...
define('DIR_PLUGINS_OBJ',   DIR_PLUGINS.'obj/');
define('DIR_PLUGINS_AUTH',  DIR_PLUGINS.'auth/');
define('DIR_PLUGINS_URL',   DIR_PLUGINS.'url/');
define('DIR_PLUGINS_DB',    DIR_PLUGINS.'db/');
define('DIR_PLUGINS_WS',    DIR_PLUGINS.'ws/');
define('DIR_PLUGINS_ADMIN', DIR_PLUGINS.'admin/');
define('DIR_PLUGINS_GUI',   DIR_PLUGINS.'gui/');
...
//define('FILE_CONF_PLUGIN',  'conf.ini');


/*  La taille des images 'vignettes'
    THUMB_HEIGHT à 0 pour garder la proportionnalité
    Todo: Mettre ça en bdd ????
 */
...
define('TABLE_LOG',         PREFIX_TABLE.'log');
define('TABLE_CONF',        PREFIX_TABLE.'conf');
define('TABLE_SITE',        PREFIX_TABLE.'site');
...
define('URL_OFFICIAL_SITE',     'http://www.hyla-project.org/');
define('URL_TEST_VERSION',      URL_OFFICIAL_SITE.'last_version.php');
...
define('TYPE_ARCHIVED',         4);     // Il s'agit d'un fichier contenu dans une archive
//define('TYPE_MULTIPLE',         4);     // Multiple file
...
define('SORT_FOLDER_FIRST',     1024);  // Répertoire en premier

//define('SORT_DEFAULT',          SORT_CAT_ALPHA | SORT_FOLDER_FIRST);
