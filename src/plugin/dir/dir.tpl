<div class="table">
	...
	<!-- BEGIN line_content -->
		<tr class="line">
			<td width="2%"><a href="{PATH_INFO}"><img src="{FOLDER_IMAGES}mimetypes/{FILE_ICON}" width="32" height="32" border="0" align="middle" alt="Infos" /></a></td>
			<td width="30%">
				<a href="{PATH_INFO}">{FILE_NAME}</a>
				<!-- BEGIN line_comment -->
				<a href="{PATH_INFO}#comment"><img src="{FOLDER_TEMPLATE}/img/comment.png" width="32" height="32" border="0" align="middle" alt="Commentaires" /><!--<sub>{NBR_COMMENT}</sub>--></a>
				<!-- END line_comment -->
			</td>
