...
class plugin_obj_image extends plugin_obj {
    ...
    function aff($paff) {
        ...
        $tab = image::getInfo($this->real_file);
        ...
        $this->tpl->set_var(array(
                'AFF_SIZE_1_4'      =>  $this->url->linkToCurrentObj(null, null, null, 'size:1/4'),
                'AFF_SIZE_1_3'      =>  $this->url->linkToCurrentObj(null, null, null, 'size:1/3'),
                'AFF_SIZE_1_2'      =>  $this->url->linkToCurrentObj(null, null, null, 'size:1/2'),
                'AFF_SIZE_1_1'      =>  $this->url->linkToCurrentObj(null, null, null, 'size:1/1'),

                'AFF_SIZE_DEFAULT'  =>  $this->url->linkToCurrentObj(null, null, null, 'size:'),

                'OBJECT_DOWNLOAD'   =>  $this->url->linkToCurrentObj('download'),
                'OBJECT_MINI'       =>  ($thumb_size && extension_loaded('gd')) ? $this->url->linkToCurrentObj(array('mini', $thumb_size)) : $this->url->linkToCurrentObj('download'),
