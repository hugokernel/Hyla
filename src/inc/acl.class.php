...
//			$userid = ($res['usr_type'] == USR_TYPE_GRP && !$group) ? $res['grpu_usr_id'] : $res['usr_id'];

			if ($group) {
				if ($res['grpu_usr_id'])
					$this->_all_rights[$res['obj_file']][$res['grpu_usr_id']] = $res['ac_rights'];
