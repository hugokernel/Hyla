 ...
 *
 * Patched by hugo (added loadcallback function)
...
/**
  ...
  * @param String  options[loadcallback] Function to run before editing
...
(function($) {
    ...
    $.fn.editable = function(target, options) {
        ...
        var loadcallback = settings.loadcallback || function() { };
        ...
        return this.each(function() {
            ...
            $(this)[settings.event](function(e) {
                ...
                if (settings.loadurl) {
                    ...
                    var loaddata = {};
                    loaddata[settings.id] = $.hyla.decodeObj(self.id);
                    ...
                    $.ajax({
                       ...
                       success: function(result) {
                          ...
                          if ($.isFunction(settings.loadcallback)) {
                              input_content = loadcallback.apply(self, [result, settings, form]);
                          } else {
                ...
                form.submit(function(e) {
                    ...
                    if (false !== submit.apply(form, [settings, self])) { 
                      ...
                      if ($.isFunction(settings.target)) {
                          ...
                          submitdata[settings.id] = $.hyla.decodeObj(self.id);
