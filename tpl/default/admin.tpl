	...
	<!-- BEGIN aff_home -->
	<p>	
		<a href="http://www.hyla-project.org/"><img src="img/hyla.png" alt="Une rainette verte" /></a>
	</p>
	...
	<ul>
		<li><a href="doc/{L10N}/index.htm" onclick="popup(this.href); return false;" title="Aide contextuelle">La documentation</a></li>
	...
	<p>
		<a href="doc/{L10N}/administration.htm#conf" onclick="popup(this.href); return false;" title="Aide contextuelle"><img src="{DIR_IMAGE}/help.png" alt="Point d'interrogation" /></a>
	</p>
	...
	<form method="post" name="ad_form" action="{ADMIN_PAGE_SAVECONF}">
		...
		<fieldset>
			...
			<div id="list" class="jhidden">
				...
				<label for="conf_dir_default_plugin">
					Plugin des dossiers par défaut :
				</label>
				<select name="conf_dir_default_plugin" id="conf_dir_default_plugin">
		...
		<fieldset>
			...
			<div id="misc" class="jhidden">
				...
				<p class="help">
					...
					apparait des caractères bizarres dans le nom des fichiers ou dossiers, modifiez cette clef
	...
	<p>
		<a href="doc/{L10N}/administration.htm#comments" onclick="popup(this.href); return false;" title="Aide contextuelle"><img src="{DIR_IMAGE}/help.png" alt="Point d'interrogation" /></a>
	</p>
	...
	<p>
		<a href="doc/{L10N}/administration.htm#anon-file" onclick="popup(this.href); return false;" title="Aide contextuelle"><img src="{DIR_IMAGE}/help.png" alt="Point d'interrogation" /></a>
	</p>
	...
	<p>
		<a href="doc/{L10N}/administration.htm#users" onclick="popup(this.href); return false;" title="Aide contextuelle"><img src="{DIR_IMAGE}/help.png" alt="Point d'interrogation" /></a>
	</p>
	...
	<!-- BEGIN users_list -->
	<table class="tab" summary="Liste des utilisateurs">
		<tr>
			<!--<th width="5%">Id</th>-->
			<th width="60%">Nom</th>
			<th width="20%">Type</th>
	...
	<p>
		<a href="doc/{L10N}/administration.htm#groups" onclick="popup(this.href); return false;" title="Aide contextuelle"><img src="{DIR_IMAGE}/help.png" alt="Point d'interrogation" /></a>
	</p>
	...
	<!-- BEGIN groups_list -->
	<table class="tab" summary="Liste des groupes">
		<tr>
			<!--<th width="5%">Id</th>-->
			<th width="20%">Nom</th>
	...
	<p>
		<a href="doc/{L10N}/administration.htm#rights" onclick="popup(this.href); return false;" title="Aide contextuelle"><img src="{DIR_IMAGE}/help.png" alt="Point d'interrogation" /></a>
	</p>

	<p>
		<a href="{URL_RIGHTS_ADD}">Ajouter un droit</a> - <a href="{URL_RIGHTS_LIST}">Liste des droits</a>
	</p>
	...
	<p>
		<a href="doc/{L10N}/administration.htm#maintenance" onclick="popup(this.href); return false;" title="Aide contextuelle"><img src="{DIR_IMAGE}/help.png" alt="Point d'interrogation" /></a>
	</p>
