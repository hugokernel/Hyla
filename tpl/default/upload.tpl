...
<fieldset>
	...
	<p>
		...
		<label for="ul_url_method_{NUM}">
			<img src="{DIR_TEMPLATE}/img/Disks.png" align="middle" width="32" height="32" alt="Disque dûr" /> Fichier local : 
		</label>
	...
	<p>
		...
		<label for="ul_file_method_{NUM}">
			<img src="{DIR_TEMPLATE}/img/WWW.png" align="middle" width="32" height="32" alt="Disque dûr" /> Fichier distant : 
		</label>
