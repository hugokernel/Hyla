...
<p>
    <a href="{DIR_ROOT}doc/{L10N}/edition.htm" onclick="popup(this.href); return false;" title="Aide contextuelle"><img src="{DIR_IMAGE}/help.png" alt="Point d'interrogation" /> </a>
</p>

<!-- BEGIN edit_description -->
<form method="post" name="desc_form" action="{FORM_EDIT_SETDESCRIPTION}#description">
<fieldset>
...
<!-- BEGIN edit_icons -->
<form method="post" name="pg_form" action="{FORM_EDIT_SETIMAGE}#icons">
<fieldset>
    ...
    <div id="icons" class="jhidden">
        <p>
            ...
            <label for="img_name_{ICON_NAME}" style="margin-right: 20px">
                <img src="{DIR_ROOT}img/perso/{ICON_NAME}" align="middle" class="icon" alt="Image" /><input name="icon_name" type="radio" id="img_name_{ICON_NAME}" value="{ICON_NAME}" <!-- BEGIN icon_checked --> checked="checked"<!-- END icon_checked --> />
            </label>
            <!-- END icon -->
        </p>
        <p>
...
<!-- BEGIN edit_plugins -->
<form method="post" name="pg_form" action="{FORM_EDIT_SETPLUGIN}#plugins">
<fieldset>
    ...
    <div id="plugins" class="jhidden">
        <p>
            ...
            <label for="pg_name_default">
                ...
                Utilise le plugin par défaut pour les dossiers ( <em>{PLUGIN_DEFAULT_DIR}</em> )
            </label>
        </p>
        <hr />
        <!-- BEGIN plugin -->
...
<fieldset>
    ...
    <div id="rights" class="jhidden">
        ...
        <a href="{URL_RIGHTS}#rights">Liste des droits par utilisateur</a> -
        <a href="{URL_ADD_RIGHTS}#rights">Ajouter des droits</a>
