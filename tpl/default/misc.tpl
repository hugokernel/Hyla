...
<div id="toolbar">
	<fieldset>
		...
		<!-- BEGIN aff_logout --><a href="{URL_LOGOUT}" title="Fermer votre session"><img src="{DIR_IMAGE}/logout.png" alt="Se déconnecter" /> Déconnecter (<span id="username">{USER_NAME}</span>)</a><!-- END aff_logout -->
